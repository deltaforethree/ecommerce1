...
const SLIDES = [
    {
        ...
        heading: "The Art of\nRefined Living",
        sub: "Discover the Spring/Summer 2025 Collection — crafted from the world's most exquisite fabrics.",
        cta: "Explore Women",
        href: "/shop/women",
    ...
    },
    {
        ...
        label: "Men's Edit",
        heading: "Understated\nElegance",
        sub: "Considered pieces that move between seasons and occasions with effortless ease.",
        cta: "Explore Men",
        href: "/shop/men",
        image: "https://images.unsplash.com/photo-1617137968427-85924c800a22?w=1600&q=85",
        align: "right",
    },
    {
        id: 3,
        label: "Accessories",
        heading: "The Perfect\nFinishing Touch",
        sub: "Handcrafted leathers, cashmere scarves, and silk pocket squares that define the look.",
